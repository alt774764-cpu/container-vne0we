...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vne0we.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vne0we.containers.anotherwebservice.com/
...
```
git clone git@github.com:alt774764-cpu/container-vne0we.git
cd container-vne0we
```
...
```
docker attach container-vne0we
```
